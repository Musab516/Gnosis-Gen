...
function calculateSimilarity(str1, str2) {
  ...
  // Calculate similarity as ratio of matching words to total words
              ...
              {result.quiz.short_answer?.map((q, i) => (
                ...
                >
                  ...
                  <textarea
                    ...
                    rows={3}
                    className={`w-full border-2 rounded-xl p-4 font-medium transition-all focus:ring-4 outline-none
                      ${darkMode
