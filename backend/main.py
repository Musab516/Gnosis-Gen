...
{{
  ...
  "short_answer": [
    {{
      "question": "A stack is a _____ data structure.",
      "correct_answer": "LIFO"
    }},
    {{
      "question": "Earth is the _____ largest planet in the solar system.",
      "correct_answer": "third"
    }}
  ]
}}

IMPORTANT RULES FOR short_answer QUESTIONS:
1. Each question MUST contain exactly one "____" (5 underscores) where the blank should be
2. The blank should replace ONE KEY WORD only
3. The correct_answer should be that ONE KEY WORD (not a full sentence)
4. Format: "Some text _____ more text." where _____ is replaced by one word
5. Examples:
   - "A queue follows _____ principle." → correct_answer: "FIFO"
   - "Python uses _____ for memory management." → correct_answer: "garbage collection"
   - "The time complexity of binary search is _____." → correct_answer: "O(log n)"

DO NOT create questions like "Explain the difference..." or "What is...?"
ALWAYS use the fill-in-the-blank format with _____ in the question.
"""
        base_params["messages"] = [
            {"role": "system", "content": system_message},
            {"role": "user", "content": prompt},
